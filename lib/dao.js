      ...
      Model.notifyObserversOf('before save', context, function(err, ctx) {
        ...
        function done(err, data, info) {
          ...
          Model.notifyObserversOf('loaded', context, function(err) {
            ...
            if (process.env.JUGGLER_MONGO_EXTENDED_OPERATIONS !== 'false') {
              obj.resetAttributes(data);
            }
            if (err) {
              cb(err, obj);
              if (!err) {
...
DataAccessObject.upsertWithWhere = function(where, data, options, cb) {
  ...
  options.daoMethodName = 'upsertWithWhere';
  var context = {
    Model: Model,
    query: query,
    hookState: hookState,
...
DataAccessObject.replaceOrCreate = function replaceOrCreate(data, options, cb) {
  ...
  options.daoMethodName = 'replaceOrCreate';
  var context = {
    Model: Model,
    query: byIdQuery(Model, id),
    hookState: hookState,
...
DataAccessObject.findOrCreate = function findOrCreate(query, data, options, cb) {
  ...
  function _findOrCreate(query, data, currentInstance) {
    ...
    function findOrCreateCallback(err, data, created) {
      if (err) return cb(err);
      options.daoMethodName = 'findOrCreate';
      var context = {
        Model: Model,
        data: data,
...
DataAccessObject._normalize = function(filter) {
  ...
  if (filter.fields && !filter.skipFieldsNormalization) {
...
DataAccessObject.destroyAll = function destroyAll(where, options, cb) {
  ...
  options.daoMethodName = 'destroyAll';
  var context = {
    Model: Model,
  ...
  function doDelete(where) {
    if (whereIsEmpty(where)) {
      ...
      try {
        ...
        where = removeUndefined(where, 'throw');
...
DataAccessObject.prototype.save = function(options, cb) {
  ...
  options.daoMethodName = 'prototype.save';
  var context = {
    Model: Model,
    instance: inst,
    hookState: hookState,
...
DataAccessObject.updateAll = function(where, data, options, cb) {
  ...
  options.daoMethodName = 'updateAll';
  var context = {
    Model: Model,
    query: {where: where},
    hookState: hookState,
...
DataAccessObject.prototype.remove =
  DataAccessObject.prototype.delete =
    DataAccessObject.prototype.destroy = function(options, cb) {
      ...
      options.daoMethodName = 'prototype.destroy';
      var context = {
        Model: Model,
        query: byIdQuery(Model, id),
        hookState: hookState,
 ...
 * @param {Object} data Data to update
 */
DataAccessObject.prototype.resetAttributes = function resetAttributes(data) {
  this.reset();
...
DataAccessObject.replaceById = function(id, data, options, cb) {
  ...
  options.daoMethodName = 'replaceById';
  var context = {
    Model: Model,
    instance: inst,
    isNewInstance: false,
...
function(data, options, cb) {
  ...
  options.daoMethodName = 'prototype.patchAttributes';
  var context = {
    Model: Model,
    where: byIdQuery(Model, getIdValue(Model, inst)).where,
    data: data,
      ...
      function triggerSave() {
        inst.trigger('save', function(saveDone) {
          inst.trigger('update', function(done) {
            ...
            function updateAttributesCallback(err, pValue) {
              if (err) return cb(err);
              var value = null;
              if (process.env.JUGGLER_MONGO_EXTENDED_OPERATIONS !== 'false') {
                value = pValue;
              ...
              Model.notifyObserversOf('loaded', ctx, function(err) {
                ...
                if (process.env.JUGGLER_MONGO_EXTENDED_OPERATIONS !== 'false' && value) {
                  inst.resetAttributes(value);
                }
